...
if(empty($imagem)){
 ...
 echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL='.$url.'">';
  ...
  if ($error == 0) {
    ...
    save_publicacao_momento_imagem($usuario,$nome,$publicacao,$caminho_imagem,$ano,$dia,$mes,$hora,$tipo);
     $id=save_tbl_publicacao_momentos_amigo_id($publicacao);
    save_tbl_publicacao_momento_imagem_amigo($id,$email,$nome,$publicacao,$caminho_imagem,$data,$hora,$tipo);
